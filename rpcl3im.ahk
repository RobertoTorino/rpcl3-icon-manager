...
Gui, Add, GroupBox,                     x10 y5 w455 h115, Select Game
Gui, Add, Text,                         x20 y25, Search game:
Gui, Add, Text, vTotalGames             x230 y25 w180 h20, Total games in database: Loading...
Gui, Add, Edit, vSearchTerm             x20 y45 w200 h22
Gui, Add, Button, gSearchGames          x230 y45 w60 h20, Search
Gui, Add, ComboBox, vGameSelect         x20 y70 w435 h200 gGameSelected, Select a game...
Gui, Add, Text, vStatusText             x20 y95 w440 h20, Ready. Select a game to manage its icon.

; Current Game Info section
Gui, Add, GroupBox,                     x10 y130 w455 h105, Current Game Info
Gui, Add, Text,                         x20 y150, Selected Game:
Gui, Add, Text, vSelectedGame           x115 y150 w300 h20, None selected
Gui, Add, Text,                         x20 y170, Current Icon Path:
Gui, Add, Text, vCurrentIconPath        x130 y170 w330 h20, -
Gui, Add, Text,                         x20 y190, Icon in rpcl3_icons:
Gui, Add, Text, vIconInFolder           x135 y190 w200 h20, Checking...
Gui, Add, Text,                         x20 y210, Sound File (SND0):
Gui, Add, Text, vSoundFileInfo          x135 y210 w200 h20, Checking...

; Icon Preview section
Gui, Add, GroupBox,                     x10 y245 w280 h185, Current Icon Preview
Gui, Add, Picture, vCurrentIcon         x20 y270 w260 h145 gShowPic1, ; Added gShowPic1 to make icon clickable
Gui, Add, Text, vIconStatus             x20 y405 w260 h20, No icon loaded

; Sound Control section
Gui, Add, GroupBox,                     x300 y245 w165 h75, Sound Control
Gui, Add, Button, gPlaySound            x310 y270 w70 h20, Play
Gui, Add, Button, gStopSound            x385 y270 w70 h20, Stop
Gui, Add, Text, vSoundStatus            x20 y430 w400 h20, No sound loaded

; Icon Actions section
Gui, Add, GroupBox,                     x300 y330 w165 h100, Icon Actions
Gui, Add, Button, gCopyExistingIcon     x310 y350 w145 h20, Copy Icon to Folder
Gui, Add, Button, gBrowseAndCopyIcon    x310 y375 w145 h20, Browse and Copy Icon
Gui, Add, Button, gDeleteIconFromFolder x310 y400 w145 h20, Delete Icon from Folder

Gui, Show, w475 h475, %title%
    ...
    if (ext = "at3") {
        ...
        if FileExist(wavPath) {
            ...
            if (wavTime >= at3Time) {
                ...
                SoundPlay, %wavPath%
                GuiControl,, SoundStatus, Playing converted WAV: %wavPath%
                return true
            }
        }
...
ShowPic1:
    ...
    Gui, Pic1:New, +Owner1 +AlwaysOnTop, %CurrentGameTitle% - PIC1.PNG
